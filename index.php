            ...
            <div class="ten columns flex-container">
               ...
               <div class="flexslider">
                  ...
                  <ul class="slides">
                     ...
                     <li>
                        <blockquote>
                           <p>Flexible to adapt to changing priorities and focus.
                              Open-minded with a teachable attitude.
                              Focused on performance and result.
                              Self-motivated with a high degree of resourcefulness requiring minimal supervision.
                              Ability to tolerate cultural, political and religious diversity in the work place.
                              Uphold professionalism and integrity
                           </p>
                           <cite>Personal Attributes</cite>
                        </blockquote>
                     </li> <!-- slide ends -->

                     <li>
                        <blockquote>
                           <p> I would Describe myself as TRUSTWORTHY,SELF-MOTIVATED AND DEPENDABLE.
                              My TRUSTWORTHYNESS means that i plan to stay working with you for a lengthy period of time. I will be a positive role model for the company and you can rely on me to do a good job for you.
                              My levels of SELF-MOTIVATION means i will come into the role and i will dedicate the time needed to learn the job quickly and to make sure i do it to a high standard with little supervision.
                              Finally, my DEPENDABILITY means i will never let you down and i will be available to work at short notice if needed to help out.
                           </p>
                           <cite>My self Description</cite>
                        </blockquote>
                     </li> <!-- slide ends -->
